...
int main() {
    ...
    const Vec3F red(212, 0, 0);

    const Sphere sphere1(Vec3F(W * 0.3, H * 0.6, 150), 100);
    const Sphere sphere2(Vec3F(W * 0.6, H * 0.5, 150), 250);
    const Sphere light(Vec3F(0, 0, 150), 100);
